<?php
/*
Plugin Name: Mingle Users Online
Plugin URI: http://wordpress.org/extend/plugins/mingle-users-online/
Description: Enable you to display how many users are online on your Wordpress site with links to their Mingle Profile Page if registered users.
Version: 0.1
Author: Jay Schires (iComNow Modified)
Based on the WP-UserOnline plugin.


Copyright 2009  Lester Chan  ( email : lesterchan@gmail.com ) & 2010 iComNow ( emails : sales@icomnow.com )
