...
class UserOnline_Options extends scbAdminPage {
	...
	function setup() {
		...
		$this->args = array(
			'page_title' => __( 'Mingle - UserOnline Options', $this->textdomain ),
			'menu_title' => __( 'Mingle Users Online', $this->textdomain ),
...
<div>Modified to use Mingle linking for users on widget and Online Pages. Visit iComNow for more Mingle Plugins and add ons!
  <div>
    <p><a href="http://icomnow.com/plugin-store/" target="_blank" style="font-size: 18px;">iComNow.com<br/><br/><img src="/wp-content/plugins/mingle-users-online/icom.png" width="200" height="75" border="0" ></a></p>
   <div class="desc">HELP by Donating for even more Mingle Plugins...Plugins take time to develop, help support the developers of the plugins you use by donating. Every donation is greatly appreciated!
<p style="text-align: center;"><center><form action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_donations">
<input type="hidden" name="business" value="jay@icomnow.com">
...
<?php
		$rows = array(
			...
			array(
				...
				'type' => 'checkbox',
				'name_tree' => 'names',
				'desc' => __( 'Link user names to their Mingled Profile page', 'wp-useronline' ),
			),
		);
